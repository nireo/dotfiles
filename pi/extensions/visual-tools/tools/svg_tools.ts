 ...
 *
 * Registered by the visual-tools extension and loaded as a normal Pi extension
 * in both the main session and subagent sessions. All three names map to this
 * one file.
 *
