...
static const char *fonts[] = {"JetBrains Mono:size=10", "Material Design Icons:size=10"};
...
static const char *dmenucmd[] = {"dmenu_run", "-m",      dmenumon, "-fn",    dmenufont, "-nb", black,
																 "-nf",       lightgray, "-sb",    darkgray, "-sf",     white, NULL};
...
static Key keys[] = {
		...
		TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
				TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7) TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_e, quit, {0}},
};
