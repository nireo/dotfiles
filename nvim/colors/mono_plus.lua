...
-- Base colors
set_hl(0, "Normal", { fg = "#B0B0B0", bg = "NONE" })
set_hl(0, "BoldKeyword", { fg = "#9EA8B6", bg = "NONE", bold = true })
set_hl(0, "Muted", { fg = "#666666", bg = "NONE" })
set_hl(0, "SoftFunction", { fg = "#D8D8D8", bg = "NONE" })
set_hl(0, "FunctionCall", { fg = "#E0E0E0", bg = "NONE" })
set_hl(0, "SoftType", { fg = "#9EAEA8", bg = "NONE", bold = true })
set_hl(0, "SoftConstant", { fg = "#B8A8C4", bg = "NONE" })
set_hl(0, "SoftNumber", { fg = "#CFBEA3", bg = "NONE" })
set_hl(0, "SoftDirectory", { fg = "#9AAEB8", bg = "NONE" })

-- UI Elements
set_hl(0, "LineNr", { fg = "#444444", bg = "NONE" })
set_hl(0, "CursorLine", { bg = "NONE" })
set_hl(0, "CursorLineNr", { fg = "#A0A0A0", bg = "NONE", bold = true })
set_hl(0, "ColorColumn", { bg = "NONE" })
set_hl(0, "SignColumn", { bg = "NONE" })
set_hl(0, "VertSplit", { fg = "#2a2828", bg = "NONE" })
set_hl(0, "WinSeparator", { fg = "#2a2828", bg = "NONE" })
set_hl(0, "StatusLine", { fg = "#909090", bg = "NONE" })
set_hl(0, "StatusLineNC", { fg = "#444444", bg = "NONE" })

-- Selection and Search
set_hl(0, "Visual", { bg = "#2d2a2a" })
set_hl(0, "Search", { fg = "#141212", bg = "#B0B0B0", bold = true })
set_hl(0, "IncSearch", { fg = "#141212", bg = "#FFFFFF", bold = true })

-- --- Colored Syntax Groups ---
-- Muted green for comments
set_hl(0, "Comment", { fg = "#7FA58A", bg = "NONE", italic = true })
set_hl(0, "SpecialComment", { fg = "#7FA58A", bg = "NONE", italic = true })
...
-- Standard Keywords (Muted and bold)
set_hl(0, "Type", { link = "SoftType" })
...
set_hl(0, "@function", { link = "SoftFunction" })
set_hl(0, "@function.builtin", { link = "FunctionCall" })
set_hl(0, "@function.call", { link = "FunctionCall" })
set_hl(0, "@function.macro", { link = "SoftFunction" })
set_hl(0, "@function.method", { link = "SoftFunction" })
set_hl(0, "@function.method.call", { link = "FunctionCall" })
set_hl(0, "@method", { link = "SoftFunction" })
set_hl(0, "@method.call", { link = "FunctionCall" })
set_hl(0, "@number", { link = "SoftNumber" })
set_hl(0, "@number.float", { link = "Normal" })
set_hl(0, "@boolean", { link = "SoftConstant" })

set_hl(0, "@type", { link = "SoftType" })
set_hl(0, "@type.builtin", { link = "SoftType" })
set_hl(0, "@type.definition", { link = "SoftType" })
set_hl(0, "@type.parameter", { link = "SoftType" })
set_hl(0, "@storageclass", { link = "BoldKeyword" })
set_hl(0, "@constructor", { link = "SoftType" })
set_hl(0, "@keyword", { link = "BoldKeyword" })
...
set_hl(0, "FloatBorder", { fg = "#3a3838", bg = "NONE" })
set_hl(0, "NormalFloat", { fg = "#B0B0B0", bg = "NONE" })
